...
action lookup_session_map() {
    ...
    //register_write(TCP_SESSION_line, 0, meta.tcp_session_map_index); //!!!
    register_read(
    ...
    register_write(TCP_SESSION_line, 0, tcp.ackNo); //!!!
}
...
action complete_session() {
    ...
    bit_or(meta.ip_to_hc_bitmap, meta.ip_to_hc_bitmap, 1 << meta.hop_count);
    register_write(ip_to_hc, meta.ip_to_hc_index, meta.ip_to_hc_bitmap);
    register_write(reg_ip_to_hc_index, 0, meta.ip_to_hc_index);
    //2nd Hash Function
